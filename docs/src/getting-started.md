...
- [Installation](getting-started/installation.md) -- install Litsea from source or crates.io
- [Quick Start](getting-started/quick-start.md) -- segment your first sentence in minutes
